...
基于<a href="https://github.com/TMAttributedLabe">https://github.com/solehe/TMAttributedLabel</a>实现，让Label也可支持select、copy等操作。
...
# 特性
* 支持<a href="https://github.com/TMAttributedLabe">https://github.com/solehe/TMAttributedLabel</a>的所有特性
* 支持select相关属性
   * `触发时长`
   * `状态` 
   * `放大镜状态`
